# Agent Development Kit (ADK) Samples for Kaggle
...
[Agent Development Kit](https://github.com/google/adk-python) for 
[Kaggle 5-Day AI AGents: Intensive Vibe Coding Course with Google](https://www.kaggle.com/competitions/5-day-ai-agents-intensive-vibecoding-course-with-google). 

Each sample agent is associated with one of the codelabs for the event. Please see the individual agent `README.md` file for a link.

## 🚀 Getting Started with Kaggle Samples
...
2.  **Clone this repository:**
    ...
    To start working with the ADK samples, first clone the public `adk-samples` repository:
    ```bash
    git clone https://github.com/google/adk-samples.git
    cd adk-samples/kaggle
    ```
...
```bash
.
├── kaggle                      # Contains all the Kaggle sample code
